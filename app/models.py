...
class Decision(models.Model):
    ...
    descripcion = models.CharField(max_length=32, blank=False, null=False)
...
class ProyectoTipoActividad(models.Model):
    """
    ...
    def __str__(self):
        main_desc = self.proyecto.nombre + " : " + self.tipo_proyecto.nombre + " : (" + self.actividad_tipo.nombre + ")"
